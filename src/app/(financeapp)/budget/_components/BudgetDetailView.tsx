  ...
  const duplicate = () =>
    startTransition(async () => {
      ...
      if (result.success && result.data) {
        ...
        toast.success(result.message ?? 'Budget duplicated')
      ...
      <div className='flex flex-col gap-5 lg:flex-row lg:items-start'>
        ...
        {/*<div className='flex flex-wrap gap-2 lg:justify-end'>
          <Button
            ...
            disabled={isPending}
          >
            <Star className='size-4' /> Set current
          </Button>
          <Dialog open={duplicateOpen} onOpenChange={setDuplicateOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Copy groups and planned items into a new historical budget.
                </DialogDescription>
              </DialogHeader>
              <div className='grid gap-3 py-2'>
                ...
                <label className='grid gap-1 text-sm'>
                  Start date
                  <input
                    aria-label='Duplicate start date'
                    type='date'
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Are you sure you want to delete &ldquo;{budget.name}&rdquo;? All groups and items
