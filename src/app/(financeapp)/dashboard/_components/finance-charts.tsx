...
// Intl compact currency keeps signs honest for negative values, which the
// former Math.round(value / 1000) hack mangled (-1500 rendered as "$-2k").
      ...
      <div className='rounded-xl border border-border bg-card p-5 shadow-sm transition-shadow hover:shadow-md lg:col-span-3'>
        <div className='mb-4 flex items-baseline justify-between'>
          <h2 className='text-sm font-semibold'>
            {viewMode === 'monthly' ? 'Estimado vs Real' : 'Tendencia mensual del año'}
          </h2>
        ...
        {isEmpty ? (
          ...
          <div
            ...
            aria-label={
              viewMode === 'monthly'
                ? 'Comparación entre el presupuesto estimado y el gasto real por categoría en el mes seleccionado'
                : 'Tendencia mensual de ingresos y gastos a lo largo del año'
            }
          >
              ...
              {viewMode === 'monthly' ? (
                ...
                <BarChart data={monthlyTrend} barGap={2}>
                  ...
                  <Bar
                    ...
                    radius={[4, 4, 0, 0]}
                  />
                  <Bar dataKey='gasto' name='Gasto' fill='var(--chart-4)' radius={[4, 4, 0, 0]} />
                </BarChart>
              )}
            </ResponsiveContainer>
          </div>
        ...
        {expenseByGroup.length === 0 ? (
          ...
          <div className='flex flex-col items-center gap-4 sm:flex-row lg:flex-col'>
            <div
              ...
              role='img'
              aria-label={`Distribución del gasto real por grupo. Total: ${formatCurrency(totalExpense)}.`}
            >
              <ResponsiveContainer width='100%' height='100%'>
                <PieChart>
                  <Pie
