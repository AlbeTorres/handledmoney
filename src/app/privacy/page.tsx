    ...
    <>
      ...
      <main className='mx-auto w-full max-w-4xl px-4 md:px-6 py-12 space-y-8'>
        ...
        <section className='space-y-4'>
          ...
          <p>
            Welcome to {APP_NAME} (&quot;the App&quot;, &quot;we&quot;, &quot;us&quot;,
            &quot;our&quot;). We are committed to protecting your privacy and being transparent
            about how we collect, use, and safeguard your personal information.
          </p>
          <p>
            {APP_NAME} is a personal finance visualization app that allows users to connect their
            accounts, log transactions, and view financial indicators and progress toward their
            financial goals — all in one place. The App is strictly read-only: we do not execute
            transactions, move funds, or take any action on your behalf.
          </p>
        ...
        <section className='space-y-4'>
          ...
          <p>
            If you sign in through a third-party provider, we also receive the information they
            share with us:
          </p>
          <ul className='list-disc pl-6 space-y-1'>
            <li>
              <strong>Google</strong>: name, email address, profile photo, and account identifier
            </li>
            <li>
              <strong>Facebook</strong>: name, email address, profile photo, and account identifier
            </li>
          </ul>

          <h3 className='text-lg font-medium'>2.2 Financial Data (via Plaid)</h3>
          <p>
            To connect your financial institutions, we use Plaid Technologies, Inc. Through Plaid,
            we may access:
          </p>
          <ul className='list-disc pl-6 space-y-1'>
          ...
          <p>
            <strong>Important:</strong> Plaid acts as a secure technical intermediary. We never
            store your banking credentials. The data we display is provided by Plaid based solely on
            the permissions you grant. You can review Plaid&apos;s privacy practices at{' '}
            <a
          ...
          <p>
            To display the real-time value of your assets (cryptocurrencies, stocks, ETFs, etc.), we
            query third-party market price APIs. In this context, we collect:
          </p>
          <ul className='list-disc pl-6 space-y-1'>
            <li>
              The types and quantities of assets you enter manually (e.g., 0.5 BTC, 10 shares of
              AAPL)
            </li>
            <li>
              The calculated market value of those assets, based on data from third-party price
              providers
            </li>
          </ul>
          <p>
            We do not share your personal data with market data providers — we only use their APIs
            to fetch price quotes.
          </p>
          ...
          <p>
            Subscription and premium plan payments are processed through Stripe, Inc. We do not
            store your credit or debit card details. Stripe handles all payment information directly
            and securely in compliance with PCI-DSS standards. You can review Stripe&apos;s privacy
            policy at{' '}
            <a
        ...
        <section className='space-y-4'>
          ...
          <ul className='list-disc pl-6 space-y-1'>
            <li>
              <strong>Performance of a contract:</strong> to provide the App services in accordance
              with our Terms of Service.
            </li>
            <li>
              <strong>Consent:</strong> when you authorize the connection of your financial accounts
              via Plaid, or when you register using Google or Facebook.
            </li>
            <li>
              <strong>Legitimate interests:</strong> to improve the App, ensure security, and
              prevent fraud.
            </li>
            <li>
              <strong>Legal compliance:</strong> when the law requires us to retain or disclose
              certain information.
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-4'>
          ...
          <ul className='list-disc pl-6 space-y-1'>
            ...
            <li>
              Cloud infrastructure providers (Amazon Web Services, Cloudflare, Neon, etc.) — hosting
              and data storage
            </li>
          ...
          <p>
            ...
            legal rights of the App and its users.
          </p>
        ...
        <section className='space-y-4'>
          ...
          <p>
            Your data is stored on cloud servers provided by reputable vendors (Amazon Web Services,
            Cloudflare, Neon, and others), located primarily in the United States and/or the
            European Union, depending on each provider&apos;s configuration.
          </p>
          ...
          <p>
            No system is completely immune to breaches. We encourage you to use a strong, unique
        ...
        <section className='space-y-4'>
          ...
          <p>
            ...
            provide the service. If you delete your account:
          </p>
          <ul className='list-disc pl-6 space-y-1'>
            <li>
              We will delete or anonymize your personal data within 30 days, unless a longer
              retention period is required by law.
            </li>
            <li>
              Certain transaction records may be retained for up to 7 years to comply with
              applicable tax or accounting obligations.
            </li>
        ...
        <section className='space-y-4'>
          ...
          <ul className='list-disc pl-6 space-y-1'>
            ...
            <li>
              <strong>Withdrawal of consent:</strong> you may withdraw consent at any time without
              affecting the lawfulness of prior processing
            </li>
          </ul>
          <p>To exercise any of these rights, use an available HandledMoney support channel.</p>
        </section>

        <section className='space-y-4'>
          <h2 className='text-xl font-semibold'>9. Cookies and Similar Technologies</h2>
          <p>We use cookies and similar technologies (session tokens, local storage) to:</p>
          <ul className='list-disc pl-6 space-y-1'>
          ...
          <p>
            You can manage cookies through your browser or device settings. Disabling certain
        ...
        <section className='space-y-4'>
          ...
          <p>
            The App is not directed to individuals under the age of 18. We do not knowingly collect
            personal information from minors. If you are a parent or guardian and believe your child
            has provided us with personal data, please contact us and we will delete it promptly.
          </p>
        </section>
        ...
        <section className='space-y-4'>
          ...
          <ul className='list-disc pl-6 space-y-1'>
            ...
            <li>
              Your continued use of the App after notification constitutes your acceptance of the
              updated policy.
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-4'>
          ...
          <p>
            If you have questions, concerns, or wish to exercise your privacy rights, use an
            available HandledMoney support channel.
          </p>
          <p className='text-sm text-muted-foreground'>{APP_NAME}</p>
        </section>
      </main>
